...
# --- 入力ウィジェット ---
prompt_from_chat = st.chat_input("質問を入力してください...")
prompt_from_voice = components.html("""
...
# --- 入力値の決定 ---
prompt = prompt_from_chat or prompt_from_voice

# --- プロンプト処理とAPI呼び出し ---
# ★★★ 変更点：`isinstance(prompt, str)` で厳格な型チェックを追加 ★★★
if prompt and isinstance(prompt, str) and not st.session_state.processing:
