...
# 環境変数名 'GEMINI_API_KEY' はStreamlitのシークレット名と一致させる
...
st.caption("私は対話型AIゆっきーだよ。数学の問題など思考する問題の答えは教えないからね💕")
 
# --- 2. クライアントとセッションの初期化（記憶力の確保） ---
 
# セッションステートにクライアントとチャットセッションが存在しない場合、初期化する
